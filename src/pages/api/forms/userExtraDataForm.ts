...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    // Validación básica
    if (!phone || !how_did_hear || semester === undefined || previous_participation === null || has_time === null) {
    ...
    console.log("✅ has_participated:", previous_participation, "→", parseBoolean(previous_participation));
    ...
    await pool
      ...
      .input("previous_participation", sql.Bit, parseBoolean(previous_participation))
