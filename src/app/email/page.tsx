...
const Loading: React.FC = () => {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        toast.success(result.notification?.message || "Formulario enviado con éxito.", {
          ...
          pauseOnHover: true,
          draggable: true,
          onClose: () => router.push(result.redirectUrl || "/email"),
        });
  ...
  return (
    <div>
      <form onSubmit={handleFormSubmit} className="background_email flex flex-col items-center justify-center gap-6 px-4 min-h-screen">
      <img 
