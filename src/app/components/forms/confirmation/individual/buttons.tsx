...
export const CheckboxButtonIndividual: React.FC<{
...
export const SubmitButtonIndividual: React.FC<{ onClick: () => void }> = ({
  onClick,
}) => {
  return (
    <button
...
export const ButtonConfirmationIndividual: React.FC<
